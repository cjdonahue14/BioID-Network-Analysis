...
setwd("C:/Users/Comma/Desktop/Network Analysis/BioID")
...
read_excel("Extended data table 5.xlsx")-> BioIDUpAllandGFP
View(BioIDUpAllandGFP)
BioIDUpAllandGFP$`HIPPIE Gene Name`->Genes
BioIDUpAllandGFP$`Highest Saint Score from vsAll or vsGFP control`->Prize
names(Prize)<-Genes
Prize
...
read_excel("Extended Data Table 7.xslx")->BioIDNodeAtts
View(BioIDNodeAtts)
...
library(RCy3)
createNetworkFromIgraph(subnetx,"BioID_PCSF_wHIPPIE22Corr_011625")
...
library(xlsx)
write.xlsx(Cluster1,sheetName = c("Cluster1"),file = "Extended data table 8.xlsx",row.names = TRUE)
write.xlsx(Cluster2,sheetName = c("Cluster2"),file = "Extended data table 8.xlsx",row.names = TRUE,append = TRUE)
write.xlsx(Cluster3,sheetName = c("Cluster3"),file = "Extended data table 8.xlsx",row.names = TRUE,append = TRUE)
write.xlsx(Cluster4,sheetName = c("Cluster4"),file = "Extended data table 8.xlsx",row.names = TRUE,append = TRUE)
write.xlsx(Cluster5,sheetName = c("Cluster5"),file = "Extended data table 8.xlsx",row.names = TRUE,append = TRUE)
write.xlsx(Cluster6,sheetName = c("Cluster6"),file = "Extended data table 8.xlsx",row.names = TRUE,append = TRUE)
write.xlsx(Cluster7,sheetName = c("Cluster7"),file = "Extended data table 8.xlsx",row.names = TRUE,append = TRUE)
write.xlsx(Cluster8,sheetName = c("Cluster8"),file = "Extended data table 8.xlsx",row.names = TRUE,append = TRUE)
write.xlsx(Cluster9,sheetName = c("Cluster9"),file = "Extended data table 8.xlsx",row.names = TRUE,append = TRUE)
write.xlsx(Cluster10,sheetName = c("Cluster10"),file = "Extended data table 8.xlsx",row.names = TRUE,append = TRUE)
write.xlsx(Cluster11,sheetName = c("Cluster11"),file = "Extended data table 8.xlsx",row.names = TRUE,append = TRUE)
write.xlsx(Cluster12,sheetName = c("Cluster12"),file = "Extended data table 8.xlsx",row.names = TRUE,append = TRUE)
write.xlsx(Cluster13,sheetName = c("Cluster13"),file = "Extended data table 8.xlsx",row.names = TRUE,append = TRUE)
write.xlsx(Cluster14,sheetName = c("Cluster14"),file = "Extended data table 8.xlsx",row.names = TRUE,append = TRUE)
write.xlsx(Cluster15,sheetName = c("Cluster15"),file = "Extended data table 8.xlsx",row.names = TRUE,append = TRUE)
write.xlsx(Cluster16,sheetName = c("Cluster16"),file = "Extended data table 8.xlsx",row.names = TRUE,append = TRUE)
write.xlsx(Cluster17,sheetName = c("Cluster17"),file = "Extended data table 8.xlsx",row.names = TRUE,append = TRUE)
write.xlsx(Cluster18,sheetName = c("Cluster18"),file = "Extended data table 8.xlsx",row.names = TRUE,append = TRUE)
write.xlsx(Cluster19,sheetName = c("Cluster19"),file = "Extended data table 8.xlsx",row.names = TRUE,append = TRUE)
